...
def main(_):
    ...
    with tf.Session(config=tf.ConfigProto(gpu_options=gpu_options)) as sess:
        ...
        for step in range(0, FLAGS.max_steps, 1):
            ...
            # _ = model_eval(sess, x1, y1, preds_adv, _train_images, train_labels, args=eval_par)
            ...
            if step % FLAGS.log_frequency == 0:
                ...
                validation_accuracy_adversarial = model_eval(sess, x1, y1, preds_adv, _test_images, test_labels, args=eval_par)
                ...
                print('Adversary: step {}, accuracy on validation set : {}'.format(step, validation_accuracy_adversarial))

                validation_writer.add_summary(validation_summary_str, step)
                # adversarial_writer.add_summary(str(validation_accuracy_adversarial), step)
